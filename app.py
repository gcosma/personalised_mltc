...
def create_network_graph(data, patient_conditions, min_or, time_horizon=None, time_margin=None):
    ...
    # Enhanced network options for better edge and arrow visibility
    net.set_options("""
    {
        "nodes": {
    ...
    for row in relationships_to_show:
        ...
        edge_width = max(2, min(8, math.log2(row['OddsRatio'] + 1)))
        ...
        net.add_edge(
            ...
            color={'color': 'rgba(50,50,50,0.8)', 'highlight': '#000000'},
