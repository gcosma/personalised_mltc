...
def main():
    ...
    if uploaded_file is not None:
        ...
        if data is not None:
            ...
            # Create tabs - Removed "📈 Sensitivity Analysis"
            tabs = st.tabs([
            ...
            # Trajectory Prediction Tab - Now index 0
            with tabs[0]:
            ...
            # Personalized Analysis Tab - Now index 1
            with tabs[1]:
            ...
            # Condition Combinations Tab - Now index 2
            with tabs[2]:
