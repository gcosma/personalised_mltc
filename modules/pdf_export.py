...
def build_document_title(export_type, dataset_info, analysis_params=None):
    ...
    export_title_map = {
        'personalised_analysis': 'Cohort-based Personalised Analysis',
...
def generate_pdf_header(dataset_info, analysis_params, export_type):
    ...
    <div class="pdf-avoid-break">
        <h1 class="pdf-title">DECODE Analysis Report</h1>
...
def convert_personalised_analysis_to_pdf(html_content):
    ...
    content = re.sub(r'<h2[^>]*>(Personalised Disease Trajectory Analysis|Cohort-based Personalised Analysis)</h2>', '', content)
...
def generate_pdf_footer():
    ...
    <div class="pdf-footer">
        <p>Generated by DECODE: Multimorbidity in Intellectual Disability Analysis System</p>
